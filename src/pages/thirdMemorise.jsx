...
import image1 from '../assets/images/3.1.jpg'
import image2 from '../assets/images/3.2.jpg'
import image3 from '../assets/images/3.3.jpg'
import image4 from '../assets/images/3.4.jpg'
import { ChevronLeftIcon, ChevronRightIcon, XMarkIcon } from '@heroicons/react/24/outline';


export function ThirdMemoriese() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-pink-50 py-8">
      ...
      >
        ...
        <div className="text-center">
          ...
          >
            Сентябрь 2017 · когда все было не до шутки...
          </motion.p>
        </div>
      </motion.header>
        ...
        >
          <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 shadow-soft border border-white/50">
            <p className="text-lg md:text-xl text-rose-700/80 italic font-light leading-relaxed text-center">
              Этот день стал для меня точкой отсчёта. Тогда я ещё не осознавал, что меня ждёт, сколько трудностей и радостей. Вы видите человека на фото справа - именно он захотел начать путь кадета, а человек слева - путеводитель.
            </p>
          </div>
        </motion.div>
        <motion.section
        ...
        >
          <div className="bg-gradient-to-r from-rose-100/50 to-pink-100/50 rounded-2xl p-8 border border-rose-200/30">
            <p className="text-2xl italic text-rose-700/70 font-light mb-4">
              "Иногда самые необдуманные решения меняют твою жизнь"
            </p>
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-center">
                <p className="italic font-light text-lg">{selectedImage.caption}</p>
